...
if($db = mysqli_connect('localhost', 'root', '')){
	...
	if(@mysqli_select_db($db,'appointment')){
		...
		// logs them in and then redirects them to the index.php file with a success message.
				...
				if($results){
					...
					{   //echo "<script type='text/javascript'> alert('welcome');</script>";
					 ...
					 if($role=="Patient")
					  ...
					  if($role=="Dentist")
					  { 
				        header('location: Home.php');}//header to the main page of the dentist
